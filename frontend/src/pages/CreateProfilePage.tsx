  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        navigate(res?.id ? `/profile/${res.id}` : '/discover');
      }
    } catch (err: any) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <div className="text-center space-y-2 mb-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-white font-['Outfit']">Add Account</h1>
        <p className="text-xs sm:text-sm text-slate-400 max-w-xl mx-auto leading-relaxed">
          Anyone can add an account to PRISM! You can add N number of accounts in the site. Add WhatsApp number & Instagram handle so anyone exploring can reach out directly.
        </p>

        {user ? (
          <div className="inline-block mt-3 px-4 py-1.5 rounded-xl bg-purple-950/60 border border-purple-500/30 text-xs text-purple-300">
            Adding account to your account ({user.email}). All accounts are managed in your dashboard.
          </div>
        ) : (
          <div className="inline-block mt-3 px-4 py-1.5 rounded-xl bg-slate-900/80 border border-slate-800 text-xs text-slate-400">
            Adding as an open directory account. Anyone can add accounts without prior login.
          </div>
        )}
      </div>
      ...
      <div className="rounded-3xl glass-card border border-slate-800 p-6 sm:p-10 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Section 5: Direct Contact Channels */}
          <div className="space-y-4 pt-6 border-t border-slate-800">
            <div className="space-y-1">
              <h3 className="text-sm font-bold text-white uppercase tracking-wider text-purple-400">
                5. Direct Contact Channels (WhatsApp & Instagram)
              </h3>
              <p className="text-xs text-slate-400">
                Provide your WhatsApp number and Instagram handle so anyone exploring the directory can directly connect with you. Contacts are public by default.
              </p>
            </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex-grow space-y-1">
                  ...
                  <input
                    ...
                    placeholder="+14155552671 or 9876543210 (with country code)"
                ...
                <div className="flex items-center gap-2 pt-2 sm:pt-4">
                  ...
                  >
                    ...
                    <span>{whatsappVisible ? 'Public Contact' : 'Hidden'}</span>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 pt-2 sm:pt-4">
                  ...
                  >
                    ...
                    <span>{instagramVisible ? 'Public Contact' : 'Hidden'}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="pt-6 border-t border-slate-800">
            ...
            >
              <span>{isSubmitting ? 'Publishing Account...' : 'Publish Account to Directory'}</span>
